...
<%@page import="adminpage.dao.product_dao"%>
...
<%@include file="./pagesource_admin/session.jsp"%>
 <%	ArrayList<product_dao> pdl = (ArrayList<product_dao>)request.getAttribute("productlist");
...
<%@include file="./pagesource_admin/product_list.html"%>
</section>
</main>
